        ...
        >
          <div className="flex flex-col sm:flex-row items-center sm:items-start sm:space-x-4 space-y-4 sm:space-y-0 mb-6">
            ...
            <div className="text-center sm:text-left">
                  ...
                  {"Hasnat Shahriyar".split('').map((char, i) => (
                    <span 
                      ...
                      style={{ 
                        ...
                        opacity: 0,
                        animation: `blur-in-char 0.4s cubic-bezier(0.4, 0, 0.2, 1) forwards ${i * 0.05}s`
                      }}
                    >
                      {char === ' ' ? '\u00A0' : char}
                    </span>
              ...
              {/* FALLBACK NAME DISPLAY - ALWAYS VISIBLE */}
              <div className="text-2xl sm:text-3xl md:text-4xl font-bold gradient-text mb-2 block">
                Hasnat Shahriyar
              </div>
