      ...
      <div className="px-4 sm:px-6 md:px-8 py-6 sm:py-8 max-w-4xl mx-auto">
          ...
          <div className="p-4 sm:p-6 md:p-8 professional-hover rounded-lg border bg-card text-card-foreground shadow-sm">
            ...
            <div className="prose prose-sm sm:prose-base max-w-none text-muted-foreground leading-relaxed text-balance">
              <p className="mb-4 text-sm sm:text-base">
                I am a passionate and motivated junior frontend developer with a
                focus on learning modern web technologies. Currently improving
                my skills in React, Next.js, and TypeScript.
              </p>
              <p className="mb-4 text-sm sm:text-base">
                I enjoy solving problems through code and am eager to contribute
                to real projects while gaining professional experience.
              </p>
              <p className="text-sm sm:text-base">
                Outside of coding, I'm exploring best practices, UI/UX
                fundamentals, and web performance optimization.
              </p>
            </div>
          </div>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            <div className="p-4 sm:p-6 professional-hover rounded-lg border bg-card text-card-foreground shadow-sm">
              ...
              <p className="text-muted-foreground text-xs sm:text-sm md:text-base">
                Familiar with HTML, CSS, JavaScript fundamentals, and building
                responsive layouts using Tailwind CSS and React.js.
              </p>
            </div>
            ...
            <div className="p-4 sm:p-6 professional-hover rounded-lg border bg-card text-card-foreground shadow-sm">
              ...
              <p className="text-muted-foreground text-xs sm:text-sm md:text-base">
                Actively learning Next.js, TypeScript, and improving
                understanding of React hooks, state management, and component
                design.
              </p>
            </div>
          </div>
        ...
        >
          ...
          <div className="p-4 sm:p-6 professional-hover rounded-lg border bg-card text-card-foreground shadow-sm">
            ...
            <p className="text-muted-foreground text-xs sm:text-sm md:text-base">
              Focused on mastering core frontend technologies and improving my
              ability to build clean, accessible, and performant web
              applications. Open to learning new tools and frameworks.
            </p>
          </div>
        </div>
        ...
        >
          ...
          <div className="p-4 sm:p-6 professional-hover rounded-lg border bg-card text-card-foreground shadow-sm">
            <div className="space-y-4 text-muted-foreground text-xs sm:text-sm md:text-base text-balance">
              <p>
                I started my journey into web development recently, motivated by
                a passion for technology and building websites. Since then, I've
                been actively learning and practicing frontend development
                fundamentals.
              </p>
              <p>
                I've worked on several personal projects to apply my skills, and
                I'm eager to gain practical experience through internships or
                entry-level roles.
              </p>
              <p>
                My goal is to grow steadily as a developer by taking on
                challenging projects and continuously expanding my knowledge.
              </p>
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            {[
              ...
              <div
                key={index}
                className="p-4 sm:p-6 professional-hover rounded-lg border bg-card text-card-foreground shadow-sm"
              >
