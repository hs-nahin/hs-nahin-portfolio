  ...
  return (
    <div className="h-full overflow-y-auto">
      <div className="p-4 sm:p-8 max-w-6xl mx-auto">
        ...
        <div className="space-y-16 mb-16">
          {projects.map((project) => (
            <div key={project.title}>
              <Card className="project-card professional-hover overflow-hidden">
              ...
              <div className="flex flex-col sm:flex-row justify-end gap-4 mt-4">
                <Button
                  className="w-full sm:w-auto flex items-center justify-center px-6 py-2 shine-effect"
                ...
                <Button
                  variant="outline"
                  className="w-full sm:w-auto flex items-center justify-center px-6 py-2"
        ...
        <Card className="p-6 sm:p-8 professional-hover mb-16">
